...
!----------------------------------------------------------------------
      ...
      if(iarg.le.0.or.AF.eq.'?') then
        ...
        write(*,'(/a)') 'name.bsw - unformatted  BSR file for radial functions'
        write(*,'(/a)') 'name.tab - column representation of orbitals, ready for plotting'
        write(*,'(a)') 
        write(*,'(a)') 'Call as:  bsw_tab  name.bsw '
        write(*,'(a)') 
        write(*,'(a)') 'then program will be asking orbitals for output '
        write(*,'(a)') 
        Stop ' '
      end if        
