!----------------------------------------------------------------------
!     target + {name.c} --> target_states
!     provide information about target states including thier labels
!----------------------------------------------------------------------
...
!----------------------------------------------------------------------
      ...
      AF = ' ';  if(iarg.gt.0) Call GET_COMMAND_ARGUMENT(1,AF)

      if(AF.eq.'?') then
        write(*,'(/a)') 'provide information about target states including thier labels'
        write(*,'(/a)') 'target + {name.c} --> target_states'
        Stop 
      end if        
