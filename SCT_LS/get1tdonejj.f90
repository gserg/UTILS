...
!     with jj-coupling  and convert it to jk-coupling
!---------------------------------------------------------------------
...
!----------------------------------------------------------------------
      ...
      write(*,'(a)') &
'                                                                       ',&
'     get1tdonejj utility generates "tmat.done" file in JK-coupling     ',&
'     based on the T-matrix elements given in "zarm.tma" file           ',&
'     obtained with DBSR in the JJ-coupling, to be able to use them     ',&
'     in the program MJK                                                ',&
'                                                                       ',&                                                                           '                                                                       ',&
'              zarm.tma + target_jj   ->    tmat.done                   ',&
'                                                                       ',&
