...
! ... find reference energy and excitation (or bindinfg) energies:
      ...
      label1 = 'label'
      write(nu,'(/5(2x,a),5(6x,a),a,a/)')  'klsp','sol',label1(1:imax), '2J','parity',  &
        'E_Ry', '    E_eV', '    E_cm', '     E_au', '        E_bind', '  target', '  channel'
      ...
      Do j = 1,nstate;  i=IPT(j)
       ...
       write(nu,'(2i5,3x,a,2i5,f14.5,F14.5,f14.1,f20.8,f14.5,2i6)') &
      ...
      write(nu,'(a)') '*'
      write(nu,'(/a)') 'You may change any parameter below and re-run'
      write(nu,*)
      write(nu,'(a,f7.3)')  'Z    = ',Z
