...
!======================================================================
!     generate all possible LS angular symmetries from list of 
!     jj configurations, converted into LS representation  
!
!     Calls: Get_cfg_jj, gen_LS_term 
!--------------------------------------------------------------------
      Use conf_jj
      ...
      Do ic=1,ncfg     ! we may Cycle over configurations not ACF

       Call Get_cfg_jj(ic)    ! iq - positive here
...
!======================================================================
!     find the possible angular symmetries for given configuration 
!     and total J-value 
!
!     Calls: Iterm_LS, Sum_iterm
!----------------------------------------------------------------------
      Use conf_LS
      ...
      Integer :: nt(msh)       ! the term under consideration
...
!======================================================================
!     check the total term and add the given angular symmetry to the
!     common list (if absent)
!----------------------------------------------------------------------
      Use conf_LS
