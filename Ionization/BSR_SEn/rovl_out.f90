...
!======================================================================
! ... R-matrix overlaps vectors:   bsr_mat.nnn + rsol.nnn --> rovl.nnn
! ... for each solution (1:khm) -> one vector: v(1:nhm) = S x rsol 
! ....where khm - number of R-matrix solutions, nhm - B-spline basis
!----------------------------------------------------------------------
